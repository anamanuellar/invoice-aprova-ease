-- Corrigir a função notify_status_change removendo o header Authorization problemático
...
begin
  ...
  if new.status is distinct from old.status then
    ...
    -- Removido o header Authorization pois current_setting não funciona em triggers
    select http_post(
